...
These accounts are required for OpenCart image installation and configuration

## OpenCart

Administrator account is set by yourselft at the time of OpenCart installation wizard
