...
The OpenCart deployment package contains a sequence software (referred to as "components") required for OpenCart to run. The important information such as the component name, installation directory path, configuration file path, port, version, etc. are listed below.
...
OpenCart on LAMP, the Web Server is Apache  
...
OpenCart on LEMP, the Web Server is Nginx    
...
| HTTP | 80 | HTTP requests for OpenCart | Required |
| HTTPS | 443 | HTTPS requests OpenCart | Optional |
